...
function cadastrar(){
    ...
    var sap = document.querySelector("#sap").value;
    var localidade = document.querySelector("#localidade").value;

    if(!name || !sap || !localidade){
        document.getElementById("validacao").classList.remove("hide")
        if (!name){
            document.getElementById("validacao").innerHTML = "O campo Nome é obrigatório"
        }
        else if (!sap){
            document.getElementById("validacao").innerHTML = "O campo SAPID é obrigatório"
        }
        else if (!localidade){
            document.getElementById("validacao").innerHTML = "O campo Localidade é obrigatório"
        }
